...
def setup_simulation_for_model(simulation: aplusml.Simulation, 
    ...
    Args:
        simulation (aplusml.Simulation): Simulation
...
def load_simulation_for_model(path_to_yaml: str,
                              ...
                              random_seed: int = 0) -> aplusml.Simulation:
...
#
###################################
def setup_nurse_optimistic(simulation: aplusml.Simulation):
...
def setup_doctor_optimistic(simulation: aplusml.Simulation):
    """Settings for "optimistic" case
    """    
    # Reset simulation to "optimistic" case
    simulation.variables['model_threshold']['value'] = 0.5
